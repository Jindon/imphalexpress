...
@switch($type)
    ...
    @case('info')
        ...
        @break
    @case('eye')
        <svg class="w-{{$width}} h-auto fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        ...
        @break
    @case('eye-close')
        <svg class="w-{{$width}} h-auto fill-current" xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" viewBox="0 0 24 24">
